# 매니페스트 프로토콜 — 실행형 발견성 (v7.2.1 계층 뷰)
...
```text
# arch-manifest · kit v7.2.1 · <프로젝트> · shared/ui 23 · widgets 6 · features 4 · entities 5 · server 7
```
...
**slice 엔트리** (1줄 티어): `knowledge-list · widgets · ⚡container · 📖 · <AGENTS.md 1행> · 소비 N곳`
...
| slice `AGENTS.md` 1행 | slice 설명 | 하네스 자동 로드 |
